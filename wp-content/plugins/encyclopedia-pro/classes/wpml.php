...
abstract class WPML {
  ...
  static function init(){
    ...
    add_Filter('register_taxonomy_args', Array(static::class, 'filterTaxonomyURLs'), 10, 2);
  ...
  static function isPostTypeSlugTranslationEnabled(){
    ...
    if (class_exists('WPML_ST_Post_Slug_Translation_Settings')){
  ...
  public static function isTaxonomySlugTranslationEnabled($taxonomy){
    if (class_exists('WPML_ST_Tax_Slug_Translation_Settings')){
